...
/usr/bin/time -a -o $method.time $raxml -m BINCAT -s ../mrpmatrix/mrp.matrix -g ../data/constraintTree.trees -n $method -N 20 -p 2222

mv RAxML_bestTree.$method $method.supertree
mv RAxML_info.* $method.log
mkdir raxml
mv RAxML_* raxml/
tar -cvzf raxml.tar.gz raxml/
rm -rf raxml
